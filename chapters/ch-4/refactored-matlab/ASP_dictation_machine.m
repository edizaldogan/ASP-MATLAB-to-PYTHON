...
try
    ...
    plot(vowels{1}.training(:,1),vowels{1}.training(:,2),'y+'); hold on;
...
function auto_save_fig()
    ...
    currentFolder = 'C:\Users\hp\Documents\Erasmus\Project\ASP_Project\chapters\ch-4\original-matlab';
