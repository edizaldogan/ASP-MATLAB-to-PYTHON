...
The algorithm will extract the shape of your vocal tract (LPC) and replace vocal cords with a robotic impulse train at a pitch of your choice.
""")
...
if uploaded_file is not None:
    ...
    st.warning("upload a short .wav file of you saying a vowel to start the app")